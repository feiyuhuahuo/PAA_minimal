...
class ResNet(nn.Module):
    def __init__(self, cfg):
        ...
        norm_function = {'frozen_BN': FrozenBatchNorm2d, 'GN': group_norm}

        self.stem = BaseStem(norm_function[cfg.stem_norm])
        ...
        for stage in stage_specs:
            ...
            for _ in range(stage.block_count):
                blocks.append(Bottleneck(in_channels,
                                         ...
                                         num_groups,
                                         stride,
                                         norm_func=norm_function[cfg.bottleneck_norm],
...
class Bottleneck(nn.Module):
    def __init__(self, in_channels, bottleneck_channels, out_channels, num_groups=1, stride=1,
                 stride_in_1x1=True, dilation=1, norm_func=FrozenBatchNorm2d, with_dcn=False):
        super().__init__()
